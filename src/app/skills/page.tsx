...
export default function SkillsPage() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-base md:text-lg max-w-3xl mx-auto">
            Years behind the timeline and in motion design have shaped both my technical mastery and creative instinct. Here’s how I can bring your ideas to life.
          </p>
        </motion.div>
  ...
  className={`w-full max-w-xl ${
    index === videoEditingSkills.length - 1
...
>
        ...
        {/* CTA Section */}
        <CTASection
          title="Ready to Frame Your Story?"
          description="Let’s turn your ideas into powerful visuals. Together, we’ll craft something remarkable — bringing your vision to life with cinematic quality and creative impact."
          buttonText="Start Framing Your Story"
          href="/contact"
        />
      </div>
    </div>
