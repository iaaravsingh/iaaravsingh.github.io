      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            Have a story waiting to be told? Let’s bring it to life—frame by frame!
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="https://mail.google.com/mail/?view=cm&to=the.aaravsinghh@gmail.com"
                      className="text-white hover:text-blue-400 transition-colors"
                    >
                      the.aaravsinghh@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Available Across Borders (Remote)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Seamless Across Time Zones</p>
                  </div>
                </div>
              </div>
            </GlassmorphismCard>
            ...
            <GlassmorphismCard className="p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-white">On Time. Every Time.</h4>
                    <p className="text-gray-400 text-sm">
                      Fast delivery without compromising purpose
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Where every cut serves the story
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Consistent Updates. Full Transparency
                    </p>
                  </div>
                </div>
              </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="animation">Podcast & Clips</option>
