      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <GlassmorphismCard className="p-4 md:p-6">
            <div className={`relative rounded-lg overflow-hidden bg-gray-900 mx-auto ${
...
/>
        ...
        >
          <GlassmorphismCard className="p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {project.insta_link && (
    <Button asChild className="bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] hover:brightness-90 border-0 text-white transition-all">
      <a
        href={project.insta_link}
        target="_blank"
        rel="noopener noreferrer"
      >
        <ExternalLink className="mr-2" size={16} />
  ...
  {project.linkedin_link && (
    <Button asChild className="bg-[#0A66C2] hover:bg-[#004182] border-0 text-white transition-all shadow-md shadow-blue-900/20">
      <a
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.4 }}
        className="mt-12 mb-8 flex justify-center w-full"
      >
        <Button
          asChild
          variant="outline"
          className="border-gray-600 text-gray-300 hover:bg-gray-800 bg-transparent px-8 py-6 rounded-xl text-lg"
        >
