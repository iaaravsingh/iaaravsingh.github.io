      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mt-0 md:mt-20 mb-3 text-white tracking-tight">
            The Editor Behind the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">Emotion</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Framing Emotion. Shaping Stories. Creating Impact.
          </p>
        </motion.div>
            ...
            header={
              <div className="relative w-full h-full min-h-[28rem] md:min-h-[16rem] rounded-xl overflow-hidden group-hover/bento:scale-[1.02] transition-transform duration-500">
                <Image
                  ...
                  width={1536}
                  height={1024}
                  className="w-full h-full object-cover object-[50%_30%] grayscale-[0] hover:grayscale-0 transition-all duration-500"
                />
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  >
                    AARAV<br />
                    <span className="block text-blue-500 text-5xl md:text-7xl font-extrabold tracking-wide">
  SINGH
</span>


                  </motion.div>
                  <div className="h-1 w-16 md:w-20 bg-purple-500 mt-1 rounded-full" />
                  <p className="text-gray-300 mt-1 text-xs md:text-sm font-medium tracking-wide uppercase">
                    Editing Stories for Impact
                  </p>
                </div>
              </div>
            }
            className="md:col-span-2 md:row-span-2 shadow-2xl shadow-blue-900/10"
          ...
          <BentoGridItem
            title="Experience"
            description="Built Through Years of Relentless Work."
            header={
              <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-black to-neutral-900 border border-white/10 flex flex-col items-center justify-center relative overflow-hidden group-hover:border-emerald-500/30 transition-colors py-8 md:py-0">
                ...
                <div className="text-emerald-500/50 text-xs font-mono uppercase tracking-[0.2em] z-10 mt-2">Years Scaling Brands & Revenue</div>
              </div>
            }
          ...
          <BentoGridItem
            title="Operating Across Borders"
            description="Seamless Across Time Zones."
            header={
          ...
          <BentoGridItem
            ...
            header={
              <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-neutral-900 to-black border border-white/5 p-6 flex items-center">
                <Quote className="text-white/10 absolute top-4 right-4" size={50} />
                <p className="text-gray-300 italic text-sm md:text-base leading-relaxed relative z-10">
                  "I don’t just cut footage — I design emotional architecture.
Every frame must justify its existence by advancing the narrative, deepening engagement, or driving action.
Because great editing isn’t about timelines — it’s about outcomes."
                </p>
              </div>
            }
          ...
          <BentoGridItem
            ...
            header={
              <div className="flex flex-1 h-full w-full items-center justify-between px-6 bg-gradient-to-r from-neutral-900 to-neutral-800 rounded-xl border border-white/5 py-4 md:py-0 min-h-[5rem]">
                <a href="https://www.linkedin.com/in/iaaravsingh" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-[#0077b5] hover:scale-110 transition-all duration-300 text-white"><Linkedin size={20} /></a>
                <a href="https://www.instagram.com/i.aaravsingh" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-pink-600 hover:scale-110 transition-all duration-300 text-white"><Instagram size={20} /></a>
                <a href="https://www.youtube.com/@AARAVSINGHGAMING" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-red-600 hover:scale-110 transition-all duration-300 text-white"><Youtube size={20} /></a>
              </div>
            }
            className="md:col-span-1"
        ...
        <CTASection
          title="Ready for the Next Big Story?"
          description="Let’s create something impossible to ignore."
          buttonText="Let’s Create Impact"
          href="/contact"
        />
      </div>
    </div>
