...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "YouTube",
      href: "https://www.youtube.com/@AARAVSINGHGAMING",
      icon: Youtube,
    },
    {
      name: "Instagram",
      href: "https://instagram.com/i.aaravsingh",
      icon: Instagram,
    },
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/iaaravsingh",
      icon: Linkedin,
    },
    {
      name: "Twitter",
      href: "https://x.com/XAARAVSINGH",
      icon: Twitter,
    },
    {
      name: "Email",
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Professional Video Editor and Motion Graphics Designer. I create visuals that move — emotionally and graphically.
            </p>
          </div>
