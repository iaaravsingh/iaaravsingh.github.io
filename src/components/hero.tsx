...
>
  ...
  <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[10px] bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-full"></span>
                ...
                >
                    Not just cutting footage — crafting stories that move with <span className="text-white font-medium">depth & emotion</span>.
                </motion.p>
